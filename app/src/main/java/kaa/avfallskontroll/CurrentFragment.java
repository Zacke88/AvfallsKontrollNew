...
public class CurrentFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        tv0.setTextAppearance(R.style.TextAppearance_AppCompat_Large_Inverse);
        row0.addView(tv0);

        TextView tv1 = new TextView(getContext());
        tv1.setText(R.string.waste);
        tv1.setTextAppearance(R.style.TextAppearance_AppCompat_Large_Inverse);
        row0.addView(tv1);

        TextView tv2 = new TextView(getContext());
        tv2.setText(R.string.business);
        tv2.setTextAppearance(R.style.TextAppearance_AppCompat_Large_Inverse);
        row0.addView(tv2);

        TextView tv3 = new TextView(getContext());
        tv3.setText(R.string.weight);
        tv3.setTextAppearance(R.style.TextAppearance_AppCompat_Large_Inverse);
        row0.addView(tv3);
